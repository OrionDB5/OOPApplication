...
import oop_gestionebiblioteca.MyCanvas;
 ...
 * @author Benedetto
 */
public class GestioneBiblioteca_GUI_Register2 extends javax.swing.JFrame {

    /**
     * Creates new form GestioneBiblioteca_GUI_Register
     */
   public GestioneBiblioteca_GUI_Register2() {
        initComponents2();
   }
 ...
 */
    ...
    private void jLabelCloseButtonMouseClicked(java.awt.event.MouseEvent evt) {                                               
        System.exit(0);
    }                                              
    ...
    private void jLabelCloseButtonMouseEntered(java.awt.event.MouseEvent evt) {                                               
        jLabelCloseButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/close_hover.png")));

    }                                              

    private void jLabelCloseButtonMouseExited(java.awt.event.MouseEvent evt) {                                              
        jLabelCloseButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/close.png")));
     

    }                                             

    private void jPanelBodyMouseClicked(java.awt.event.MouseEvent evt) {                                        
        setVisible(false);
    }                                       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestioneBiblioteca_GUI_Register.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
